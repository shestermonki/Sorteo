...
export default class DashboardComponent {
  ...
  redirect(){
    window.open('https://discord.com/oauth2/authorize?client_id=1216790330196627477&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A3001%2Fauthorize-acount%2Flogin&scope=identify')
  }
